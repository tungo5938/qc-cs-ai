...
- Name: admin.spec.ts >> Admin queue >> PM can approve issue from queue
- Location: e2e/admin.spec.ts:29:7
...
Call log:
  - waiting for locator('div').filter({ hasText: '[E2E] Approve test 1775191284029' }).first().getByTitle(/phê duyệt/i)
