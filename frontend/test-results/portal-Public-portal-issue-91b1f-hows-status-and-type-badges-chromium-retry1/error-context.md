...
- Name: portal.spec.ts >> Public portal >> issue detail shows status and type badges
- Location: e2e/portal.spec.ts:68:7
...
Call log:
  ...
  - waiting for getByText(/đã duyệt/i)
